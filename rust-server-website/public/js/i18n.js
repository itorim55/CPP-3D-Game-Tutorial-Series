...
const I18N = {
  pt: {
    ...
    'home.antiCheatDesc': 'Moderação ativa ao estilo <b>camomo_10</b>: cheaters apanhados em direto, provas gravadas e banimentos públicos. Vê a <a href="/staff">lista de bans</a>.',
    ...
    'home.noP2wDesc': 'Nada de kits pagos nem loot à venda. Os apoios ao servidor dão apenas cosméticos e cor no chat — o jogo é igual para todos.',
    ...
    'store.howDesc': 'Ganhas <b style="color:var(--gold)" id="rate">1,000 gemas por cada hora jogada</b> no servidor — automaticamente, sem fazer nada. As gemas trocam-se aqui por recompensas <b>100% cosméticas</b>: nada do que está na loja dá vantagem in-game. Inicia sessão com a Steam para veres o teu saldo e resgatar.',
    ...
    'staff.p1': '<b>1. Zero vantagens in-game.</b> Admins que jogam a wipe usam uma conta separada sem poderes, ou não jogam de todo. Nunca se dá spawn a itens numa wipe ativa, nunca se usa noclip/vanish para ganhar vantagem, nunca se espreita a base de ninguém "só para ver".',
    'staff.p2': '<b>2. Provas sempre.</b> Nenhum ban por cheating sem gravação. As provas são guardadas e, sempre que possível, publicadas — como faz o camomo_10.',
    'staff.p3': '<b>3. Bans públicos.</b> Todos os banimentos aparecem na lista pública abaixo, com motivo e o admin responsável. A comunidade pode contestar qualquer decisão no Discord.',
